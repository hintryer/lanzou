...
echo.
mkdir "浏览器相关" 2>nul
echo 📥 下载 → 浏览器相关 \ chrome_149.0.7827.201_uncompressed.exe
curl -L -# -o "浏览器相关\chrome_149.0.7827.201_uncompressed.exe" "https://gh-proxy.com/https://github.com/Bush2021/chrome_installer/releases/download/149.0.7827.201/x64_149.0.7827.201_chrome_installer_uncompressed.exe"
echo.
mkdir "影音工具" 2>nul
...
echo.
mkdir "浏览器相关" 2>nul
echo 📥 下载 → 浏览器相关 \ uBlockOriginLite_2026.622.2316.crx
curl -L -# -o "浏览器相关\uBlockOriginLite_2026.622.2316.crx" "https://clients2.google.com/service/update2/crx?response=redirect&acceptformat=crx2,crx3&prodversion=130.0.0.0&x=id%3Dddkjiahejlhfcafbddmgiahcphecmpfh%26uc"
echo.
mkdir "影音工具" 2>nul
