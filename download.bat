...
echo.
mkdir "影音工具" 2>nul
echo 📥 下载 → 影音工具 \ PotРlayer-260422.exe
curl -L -# -o "影音工具\PotРlayer-260422.exe" "https://dlink.host/1drv/aHR0cHM6Ly8xZHJ2Lm1zL3UvYy9kMTk2Y2Y1YmZjNWM1YmY3L0lRQlhNb0lHNk9HLVJyb0lLS3cxMHlaSUFVOV9CR2FvVlVRanF4TlBISEMtWXJrP2U9c01TelJk.exe"
echo.
mkdir "浏览器相关" 2>nul
