...
echo.
mkdir "浏览器相关" 2>nul
echo 📥 下载 → 浏览器相关 \ chrome_149.0.7827.115_uncompressed.exe
curl -L -# -o "浏览器相关\chrome_149.0.7827.115_uncompressed.exe" "https://gh-proxy.com/https://github.com/Bush2021/chrome_installer/releases/download/149.0.7827.115/x64_149.0.7827.115_chrome_installer_uncompressed.exe"
echo.
mkdir "影音工具" 2>nul
